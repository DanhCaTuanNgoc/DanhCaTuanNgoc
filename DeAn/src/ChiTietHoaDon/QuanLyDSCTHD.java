...
public class QuanLyDSCTHD {
	...
	public void menu() {
		...
		while(true) {
			...
			System.out.println("   !        3. Danh sach CT hoa don da xoa.    !");
			System.out.println("   !        4. Tim kiem CT hoa don.            !");
			System.out.println("   !        5. Sua CT hoa don.                 !");
			System.out.println("   !        6. Xoa CT hoa don.                 !");
